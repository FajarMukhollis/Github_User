package com.fajar.submission3.data

import android.app.Application
import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import com.fajar.submission3.data.database.DaoUser
import com.fajar.submission3.data.database.DatabaseUser
import com.fajar.submission3.data.datastore.DataStoreUser
import com.fajar.submission3.data.Service.ApiService
import com.fajar.submission3.data.Service.RetrofitService
...
class Repo(private val application: Application) {
    ...
    private val dataStore: DataStoreUser

    init {
        val database: DatabaseUser = DatabaseUser.getInstance(application)
        dao = database.userDao()
        dataStore = DataStoreUser.getInstance(application)
    }
